...
export function BottomTabBar() {
  ...
  return (
    // data-tab-bar lets the Marshal floater measure the bar it must never cover.
    <nav
      data-tab-bar
      className="fixed inset-x-0 bottom-0 z-10 flex border-t-[3px] border-double border-ink bg-paper"
    >
      {TABS.map((tab) => {
